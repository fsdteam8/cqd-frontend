          ...
          <div className="md:col-span-1">
            ...
            <ul className="list-decimal list-inside pt-4 space-y-5">
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                <strong>
                How much does commercial cleaning in Northampton cost?
                </strong>{" "}
                <br />
              ...
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                ...
                <br />  Absolutely — we use non-toxic, sustainable products and modern equipment.
              </li>
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                <strong>What types of businesses do you serve in Northampton?</strong> <br /> 
              ...
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                <strong>How can I get a quote for cleaning services in Northampton?</strong>{" "}
