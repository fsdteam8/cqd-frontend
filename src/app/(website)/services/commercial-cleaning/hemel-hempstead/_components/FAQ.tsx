          ...
          <div className="md:col-span-1">
            ...
            <ul className="list-decimal list-inside pt-4 space-y-5">
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                ...
                <br />
                Pricing depends on premises size, type of cleaning, and frequency.
                We offer tailored, affordable packages for all businesses.
              </li>
              ...
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                <strong>What types of businesses do you serve in Hemel Hempstead?</strong>
                <br />
                We clean offices, schools, nurseries, gyms, restaurants, hotels,
                healthcare facilities, retail shops, workshops, data centres, and more.
              </li>

              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                <strong>How can I get a quote for cleaning services in Hemel Hempstead?</strong>
                <br />
              ...
              <li className="text-base md:text-lg font-normal leading-[120%] text-primary">
                ...
                <br />
                Yes, we offer specialist cleaning for theatres, soft play areas,
                dental clinics, data centres, mosques, and other unique commercial spaces.
              </li>
            </ul>
          </div>
        </div>
