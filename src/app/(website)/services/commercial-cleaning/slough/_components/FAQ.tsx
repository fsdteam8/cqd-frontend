       ...
       <section className="container max-w-9xl mx-auto px-4 md:px-6  py-8 md:py-10 lg:py-12">
        ...
        <Accordion type="single" collapsible className="w-full space-y-4 mt-5">
          ...
          <AccordionItem value="pricing">
            ...
            <AccordionContent className="text-base font-medium text-gray-700">
               Yes, we use non-toxic, sustainable cleaning products and modern equipment..
          ...
          <AccordionItem value="deep-cleaning">
            <AccordionTrigger className="text-xl md:text-[22px] lg:text-2xl font-semibold text-[#14213d]">
              What types of businesses do you clean in Slough?
           ...
           <AccordionItem value="cleaning">
            <AccordionTrigger className="text-xl md:text-[22px] lg:text-2xl font-semibold text-[#14213d]">
              How do I get a quote for cleaning services in Slough?

            </AccordionTrigger>
            <AccordionContent className="text-base font-medium text-gray-700">
              You can contact us via phone, email, or our website for a free, no-obligation quote.

            </AccordionContent>
          </AccordionItem>
           <AccordionItem value="c-cleaning">
            <AccordionTrigger className="text-xl md:text-[22px] lg:text-2xl font-semibold text-[#14213d]">
             Can you handle specialist cleaning?

            </AccordionTrigger>
            <AccordionContent className="text-base font-medium text-gray-700">
               Yes, we provide specialist cleaning for theatres, soft play areas, dental clinics, data centres, mosques, and other unique commercial spaces.
