...
const CQDPaginationComponent: React.FC<PaginationProps> = ({
  totalPages,
  currentPage,
  onPageChange,
}) => {
        ...
        <PaginationItem>
          ...
          >
            <ChevronLeft
              className={cn(
                "h-4 w-4",
                currentPage === 1 && "text-white dark:text-[#6841A5] "
              )}
            />
          </PaginationLink>
        </PaginationItem>
        ...
        <PaginationItem>
          ...
          >
            <ChevronRight
              className={cn(
                "h-4 w-4",
                currentPage === totalPages && "text-white dark:text-[#6841A5]"
              )}
            />
          </PaginationLink>
        </PaginationItem>
...
export default CQDPaginationComponent;
