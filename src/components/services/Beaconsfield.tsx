      ...
      <section>
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 lg:gap-40 py-8 md:py-10 lg:py-12">
          <div className="md:col-span-1">
            ...
            <p className="text-base md:text-lg font-normal leading-[120%] text-primary pt-4">
             We offer a wide range of commercial cleaning services in Beaconsfield, designed to meet the needs of different industries and businesses. Whether you run an office, retail outlet, or hospitality venue, our team provides reliable cleaning to keep your premises safe and professional.

              <br />
              Our services include daily and weekly <strong> office cleaning,</strong> ensuring a tidy and productive workspace, as well as specialist <strong>carpet cleaning</strong> to remove stains, dirt, and allergens. For businesses that want a perfect first impression, we provide streak-free <strong>window cleaning</strong> both inside and out. We also maintain <strong>washrooms</strong> to the highest hygienic standards, making them safe and welcoming for staff and visitors alike.

              <br />
              For customer-facing businesses, we deliver professional <strong>retail cleaning,</strong> ensuring shops and showrooms remain spotless, while our <strong>restaurant and pub cleaning</strong> covers everything from kitchens to dining areas. Hospitality businesses can rely on our <strong>hotel cleaning services</strong> to refresh guest rooms, lobbies, and shared spaces to professional standards.
              <br />
              We also serve educational and healthcare sectors with safe and hygienic <strong>school, nursery, and GP cleaning,</strong> along with specialist services for <strong>gyms, cinemas, theatres, event venues, industrial workshops, transport fleets, and marine vessels.</strong> Whatever your industry, our cleaning team provides tailored solutions to keep your premises looking their very best.
