      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-8">
          ...
          {isLoading ? (
            ...
            <Card className="relative rounded-none rounded-tr-3xl rounded-bl-3xl bg-[#cd803260] border-gray-200 transition-all duration-300 hover:shadow-lg">
          ...
          {silverIsLoading ? (
            ...
            <Card className="relative rounded-none rounded-tr-3xl rounded-bl-3xl bg-[#D99058] text-white border-blue-900 transform lg:scale-110  transition-all duration-300 hover:shadow-lg">
              <CardHeader className="text-left pb-4">
                ...
                <div className="mt-4">
                  ...
                  <span className="text-sm ml-2 !text-white">(EX VAT)</span>
                </div>
